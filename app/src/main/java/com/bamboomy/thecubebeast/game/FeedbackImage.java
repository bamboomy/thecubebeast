...
public class FeedbackImage {
    ...
    private static float x1 = -0.5f, x2 = 0.5f, y1 = 0.5f, y2 = 1.0f, z = -2f;
    ...
    private int[] images = {
            R.drawable.feedback_better,
            R.drawable.feedback_excellent,
            R.drawable.feedback_great,
            R.drawable.feedback_roll,
            R.drawable.feedback_magnificent,
            R.drawable.feedback_well_done
    };

    FeedbackImage(Context mContext) {
    ...
    void show() {
        ...
        loadGLTexture(mContext, images[(int) (images.length * Math.random())]);
